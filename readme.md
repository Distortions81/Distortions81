...
<table>
  ...
  <tr>
    ...
    <td align="center" width="20%">
      <a href="https://stratumstats.m45core.com/">
...
| 22 | [StratumStats](https://stratumstats.m45core.com/) | Public dashboard / private repository | Bitcoin mining observability | Measurement-first mining-pool dashboard that publishes separately computed block-template delivery, availability, Stratum protocol timing, TLS, sample counts, and coinbase/fee evidence. Raw observations are append-only and independently recomputable. |
| 23 | StratumScout | Private | Distributed measurement probes | Disposable regional Stratum measurement probe for StratumStats. It fetches compatible endpoints, performs bounded observations, uploads authenticated compressed batches, and exits without submitting shares or retaining durable state. |
...
| Infrastructure, embedded, and Bitcoin tooling | BatteryMesh, ProtonSync, PoolCensus, StratumStats, StratumScout, goBitaxeRemote, ScriptSigSearch, stratum-binary-batch, bitgraph | Telemetry, automation, mining, data inspection, pool measurement, and operational tooling that complements the public Bitcoin and firmware projects. |
