...
My Bitcoin mining software, firmware, and observability work lives under the [M45Core GitHub organization](https://github.com/M45Core). Its public projects include M45-goPool, M45-Core-Firmware, M45-Gamma-Firmware, StratumStats, and StratumScout, alongside related private operational tooling.
...
<table>
  ...
  <tr>
    <td align="center" width="20%">
      <img src="assets/project-thumbnails/encore-4a.png" alt="Encore-4A sidecar VDP shadow output thumbnail" width="150"><br>
      <sub>Encore-4A</sub>
    </td>
    <td align="center" width="20%">
      <img src="assets/project-thumbnails/project-retrace.png" alt="Project-Retrace MC68000 monitor thumbnail" width="150"><br>
      <sub>Project-Retrace</sub>
    </td>
    <td align="center" width="20%">
      <img src="assets/project-thumbnails/vectorfpga.png" alt="VectorFPGA 3D Doom vector-rendering thumbnail" width="150"><br>
      <sub>VectorFPGA</sub>
    </td>
    <td align="center" width="20%">
    ...
    <td align="center" width="20%">
      <a href="https://github.com/M45Core/StratumStats">
        <img src="assets/project-thumbnails/stratumstats.png" alt="StratumStats Bitcoin mining-pool performance dashboard" width="150"><br>
        <sub>StratumStats</sub>
      </a>
    </td>
  </tr>
</table>
...
| [StratumStats](https://github.com/M45Core/StratumStats) | Bitcoin mining observability | Live, measurement-first dashboard comparing Bitcoin mining-pool block-template delivery, availability, Stratum connection and protocol timings, TLS, sample counts, and clearly separated fee evidence. [Dashboard](https://stratumstats.m45core.com/) |
...
| 22 | [StratumStats](https://github.com/M45Core/StratumStats) | Public | Bitcoin mining observability | Measurement-first mining-pool dashboard that publishes separately computed block-template delivery, availability, Stratum protocol timing, TLS, sample counts, and coinbase/fee evidence. Raw observations are append-only and independently recomputable. [Dashboard](https://stratumstats.m45core.com/) |
| 23 | [StratumScout](https://github.com/M45Core/StratumScout) | Public | Distributed measurement probes | Disposable regional Stratum measurement probe for StratumStats. It fetches compatible endpoints, performs bounded observations, uploads authenticated compressed batches, and exits without submitting shares or retaining durable state. |

### Public Work By Area
| Area | Repositories |
| --- | --- |
| Hardware, firmware, and infrastructure | [TangMiner](https://github.com/Distortions81/TangMiner), [ESP-Miner](https://github.com/Distortions81/ESP-Miner), [M45-goPool](https://github.com/M45Core/M45-goPool) ([Pool](https://m45core.com/)), [M45-Gamma-Firmware](https://github.com/M45Core/M45-Gamma-Firmware) ([Flasher](https://distortions81.github.io/M45-Gamma-Firmware/)), [M45-Core-Firmware](https://github.com/M45Core/M45-Core-Firmware) ([Flasher](https://distortions81.github.io/M45-Core-Firmware/)), [StratumStats](https://github.com/M45Core/StratumStats) ([Dashboard](https://stratumstats.m45core.com/)), [StratumScout](https://github.com/M45Core/StratumScout), [DaVinci-Resolve-Container](https://github.com/Distortions81/DaVinci-Resolve-Container), [Canon-Webcam-Linux](https://github.com/Distortions81/Canon-Webcam-Linux), [PCB-Frame](https://github.com/Distortions81/PCB-Frame), [IrPowerOn](https://github.com/Distortions81/IrPowerOn), [go-smartwatch](https://github.com/Distortions81/go-smartwatch) |
...
| Smaller utilities and preservation | [SolarLightCalc](https://github.com/Distortions81/SolarLightCalc), [goClanLordImgExport](https://github.com/Distortions81/goClanLordImgExport) / [goClanLordSndExport](https://github.com/Distortions81/goClanLordSndExport), [goPixelChat](https://github.com/Distortions81/goPixelChat), [goRaycast2](https://github.com/Distortions81/goRaycast2), [goSnake](https://github.com/Distortions81/goSnake) / [goSnakeServ](https://github.com/Distortions81/goSnakeServ), [Collatz](https://github.com/Distortions81/Collatz), [SeqPrimeGo](https://github.com/Distortions81/SeqPrimeGo), [InterferencePattern](https://github.com/Distortions81/InterferencePattern), [goWordSearch](https://github.com/Distortions81/goWordSearch), [goCardinal](https://github.com/Distortions81/goCardinal), [goKillComments](https://github.com/Distortions81/goKillComments), [sha256-visualizer](https://github.com/Distortions81/sha256-visualizer), [RomeroDoomDump](https://github.com/Distortions81/RomeroDoomDump), [yampmud](https://github.com/Distortions81/yampmud) |
...
| Infrastructure, embedded, and Bitcoin tooling | BatteryMesh, ProtonSync, PoolCensus, goBitaxeRemote, ScriptSigSearch, stratum-binary-batch, bitgraph | Telemetry, automation, mining, data inspection, pool measurement, and operational tooling that complements the public Bitcoin and firmware projects. |
